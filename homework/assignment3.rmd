...
Submit a single knitr file (named `homework3.rmd`) by email to chiara.di.gravio@vanderbilt.edu.
...
Save the `2019/proj_wr18.csv` file in your working directory.  Read
