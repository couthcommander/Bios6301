...
Submit a single knitr file (named `homework3.rmd`) by email to sarah.c.lotspeich@vanderbilt.edu.
...
Save the `2019/proj_wr19.csv` file in your working directory.  Read
